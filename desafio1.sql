...
(
    usuario_id	INT,
    cancoes_id	INT,
    historico_de_reproducoes	varchar(300),
...
INSERT INTO SpotifyClone.cancoes_tabela (album_id,cancoes,duracao_segundos)
VALUES
    (1, "Soul For Us", 200),
    ...
    (7, "Hard And Time", 135),
    (7, "Honey, Im A Lone Wolf", 150),
    (8, "She Thinks I Wont Stay Tonight", 166),
    (8, "He Heard Youre Bad For Me", 154),
    (8, "He Hopes We Cant Stay", 210),
    (8, "I Know I Know", 117),
    (9, "Hes Walking Away", 159),
    (9, "Hes Trouble", 138),
    (9, "I Heard I Want To Bo Alone", 120),
    (9, "I Ride Alone", 151),
    (10, "Honey", 79),
    (10, "You Cheated On Me", 95),
    (10, "Wouldnt It Be Nice", 213),
    (10, "Baby", 136),
